...
export default {
  name: publicSettings.css.suffix + 'btn',
  ...
  computed: {
    ...
    classes() {
      ...
      for (let key in Contextualable.props) {
        ...
        classes[`${this.$ui.cssSuffix}text--${key}`] = !this.disabled && this.colorForText && this[key];
      }
  ...
  methods: {
    ...
    genContent() {
      return this.$createElement(
        'div',
        { 'class': publicSettings.css.suffix + 'btn__content' },
        [this.$slots.default]
      )
    },
  },
